...
import { FileText, Printer, X, LayoutList, ShoppingCart, PlusCircle,Lightbulb  } from 'lucide-react';
export default function Header({navigate}:{navigate:(agr0:string)=>void}) {
  return (
     <>
      <aside className="w-64 bg-white shadow-md h-screen p-6 flex flex-col gap-6">
